...
lambda = 0.3298770
lasso_model <- glmnet(actPersonbyNote.trainFeatures, actPersonbyNote.trainTarget, alpha = .85, lambda = lambda, standardize = F)
pred_rf = predict(lasso_model, s = lambda, actPersonbyNote.testFeatures) 
postResample(pred_rf, actPersonbyNote.testTarget)
cor.test(pred_rf, actPersonbyNote.testTarget, method="kendall")
